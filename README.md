...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client:0.4.5")
}
```
...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client-robust:0.4.5")
}
```
...
```kotlin
dependencies {
    implementation("dev.kourier:amqp-client-opentelemetry:0.4.5")
